...
##说明
如果本地push出错，centos 6.5 需要修改/etc/sysconfig/docker文件，在OPTIONS里面追加参数：--insecure-registry 10.18.1.99:5000
默认是从远程拉取镜像的，如果需要默认从本地拉取，那么需要再追加启动参数：--add-registry=10.18.1.99:5000 
